          ...
          <div class="property-tab-section search-filter-form">
            ...
            <div class="tab-content1" id="for-sale">
              <div class="filters">
                ...
                <div class="search-button">
                  <button id="search-sale" onclick="searchOffMarketProperties('sale')">Search <svg
            ...
            <div class="tab-content1" id="for-rent" style="display: none;">
              <div class="filters">
                ...
                <div class="search-button">
                  <button id="search-rent" onclick="searchOffMarketProperties('rent')">Search <svg
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                      <path
                        d="M18.031 16.6168L22.3137 20.8995L20.8995 22.3137L16.6168 18.031C15.0769 19.263 13.124 20 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20 13.124 19.263 15.0769 18.031 16.6168ZM16.0247 15.8748C17.2475 14.6146 18 12.8956 18 11C18 7.1325 14.8675 4 11 4C7.1325 4 4 7.1325 4 11C4 14.8675 7.1325 18 11 18C12.8956 18 14.6146 17.2475 15.8748 16.0247L16.0247 15.8748Z">
                      </path>
                          ...
                          <div class="property-boxarea">
                                ...
                                <div class="swiper-wrapper">
                                  ...
                                  @if($listing->gallery && count($listing->gallery) > 1)
                                    @for($i = 1; $i < min(count($listing->gallery), 4); $i++)
                                      <div class="swiper-slide">
                                        <img src="{{ asset('storage/' . $listing->gallery[$i]) }}"
                                          alt="{{ $listing->property_title }}">
                                      </div>
                                    @endfor
                                  @endif
                            ...
                            <div class="category-list">
                              <ul>
                                ...
                                <li><a href="{{ route('off-market-listing.show', $listing->id) }}">{{ $listing->purpose }}</a>
                                </li>
                              </ul>
                            </div>
                            <div class="content-area">
                              <a
                                href="{{ route('off-market-listing.show', $listing->id) }}">{{ $listing->property_title }}</a>
                              ...
                              <ul>
                                <li><a href="#"><img src="{{ asset('assets/img/icons/bed1.svg') }}"
                                      alt="housebox">{{ $listing->bedrooms ?? 'N/A' }}</a></li>
                                <li><a href="#"><img src="{{ asset('assets/img/icons/bath1.svg') }}"
                                      alt="housebox">{{ $listing->bathrooms ?? 'N/A' }}</a></li>
                                <li><a href="#"><img src="{{ asset('assets/img/icons/sqare1.svg') }}"
                                      alt="housebox">{{ $listing->area_size ?? 'N/A' }} sq</a></li>
                              </ul>
                              ...
                              <div class="btn-area">
                                <a href="#" class="nm-btn price-element"
                                  data-original-price="{{ $listing->price }}">£{{ number_format($listing->price) }}</a>
                                <a href="javascript:void(0)" class="heart"><img
                                    src="{{ asset('assets/img/icons/heart1.svg') }}" alt="housebox" class="heart1"> <img
                                    src="{{ asset('assets/img/icons/heart2.svg') }}" alt="housebox" class="heart2"></a>
                              </div>
                            </div>
                          </div>
                        </div>
