                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 30px 0; color: #64748b; font-size: 16px; line-height: 1.6;">
                                ...
                                @if($listing->is_off_market) <span style="background-color: #8046F1; color: #ffffff; font-size: 10px; padding: 2px 8px; border-radius: 4px; font-weight: bold; margin-left: 5px; vertical-align: middle;">OFF-MARKET</span> @endif
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $listing->is_off_market ? route('off-market-listing.show', $listing->id) : route('listing.show', $listing->id) }}" 
