...
@section('content')
  ...
  <div class="hero-area-slider">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="hero-header-area text-center">
              ...
              <div class="btn-area1">
                <a href="{{ route('listing.show', 1) }}" class="theme-btn1">Find Your Dream Home Now <span
                    class="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                      fill="currentColor">
                ...
                <a href="{{ route('listings.index') }}" class="theme-btn2">View Listings<span class="arrow1"><svg
    ...
    <div class="hero1-section-area">
      <img src="{{ asset('assets/img/all-images/hero/hero-img2.png') }}" alt="Propertyfinda" class="hero-img1">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="hero-header-area text-center">
              ...
              <div class="space40"></div>
              <div class="btn-area1">
                <a href="{{ route('listings.index') }}" class="theme-btn1">Find Your Dream Home Now <span
                    class="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                      fill="currentColor">
                      <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                    </svg></span><span class="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
    ...
    <div class="hero1-section-area">
      <img src="{{ asset('assets/img/all-images/hero/hero-img3.png') }}" alt="Propertyfinda" class="hero-img1">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="hero-header-area text-center">
          ...
          <div class="property-tab-section search-filter-form">
            ...
            <div class="tab-content1" id="for-sale">
              <div class="filters">
                ...
                <div class="filter-group">
                  ...
                  <input type="text" id="location-sale" placeholder="Enter location" class="form-control"
                ...
                <div class="search-button">
                  <button id="search-sale" onclick="searchProperties('sale')">Search <svg
            ...
            <div class="tab-content1" id="for-rent" style="display: none;">
              <div class="filters">
                ...
                <div class="search-button">
                  <button id="search-rent" onclick="searchProperties('rent')">Search <svg
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                      <path
                        d="M18.031 16.6168L22.3137 20.8995L20.8995 22.3137L16.6168 18.031C15.0769 19.263 13.124 20 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20 13.124 19.263 15.0769 18.031 16.6168ZM16.0247 15.8748C17.2475 14.6146 18 12.8956 18 11C18 7.1325 14.8675 4 11 4C7.1325 4 4 7.1325 4 11C4 14.8675 7.1325 18 11 18C12.8956 18 14.6146 17.2475 15.8748 16.0247L16.0247 15.8748Z">
                      </path>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="about-images-area">
            <div class="img2 image-anime reveal">
              <img src="{{ asset('assets/img/all-images/about/about-img2.png') }}" alt="Propertyfinda">
            </div>
            <div class="img1 image-anime reveal">
              <img src="{{ asset('assets/img/all-images/about/about-img1.png') }}" alt="Propertyfinda">
            </div>
            <div class="author-img aniamtion-key-1">
              <h3>Our Happy Customer</h3>
              <div class="space18"></div>
              <img src="{{ asset('assets/img/all-images/others/author-img1.png') }}" alt="Propertyfinda">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-5">
          <div class="about-heading heading1">
            ...
            <div class="space18"></div>
            <p data-aos="fade-left" data-aos-duration="900">At HouseBox, we're redefining the way people find, sell, and
              invest in properties. Our mission is to simplify real estate by provide innovative solutions, expert
              guidance.</p>
            <div class="space32"></div>
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1100">
              <a href="{{ route('listings.index') }}" class="theme-btn1">See All Properties <span class="arrow1"><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                    <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
            ...
            <div class="col-lg-12 m-auto">
              ...
              <div class="tab-content" id="pills-tabContent" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                  tabindex="0">
                  <div class="swiper property-slider-sale">
                          ...
                          <div class="swiper-slide">
                            <div class="property-boxarea">
                                  ...
                                  <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                      @if($listing->images && count($listing->images) > 0)
                                        <img src="{{ Storage::url($listing->images[0]) }}"
                                          alt="{{ $listing->property_title ?? $listing->title }}">
                                      @else
                                        <img src="{{ asset('assets/img/all-images/properties/property-img2.png') }}"
                                          alt="Propertyfinda">
                                      @endif
                                    </div>
                                    @if($listing->images && count($listing->images) > 1)
                                      @for($i = 1; $i < min(count($listing->images), 4); $i++)
                                        <div class="swiper-slide">
                                          <img src="{{ Storage::url($listing->images[$i]) }}"
                                            alt="{{ $listing->property_title ?? $listing->title }}">
                                        </div>
                                      @endfor
                                    @endif
                              ...
                              <div class="content-area">
                                <a
                                  href="{{ route('listing.show', $listing->id) }}">{{ $listing->property_title ?? $listing->title }}</a>
                                <div class="space18"></div>
                                <p>{{ $listing->address ?? $listing->location ?? $listing->city }},
                                  {{ $listing->state ?? 'UK' }}
                                </p>
                                <div class="space24"></div>
                                <ul>
                                  <li><a href="#"><img src="{{ asset('assets/img/icons/bed1.svg') }}"
                                        alt="Propertyfinda">{{ $listing->bedrooms ?? 'N/A' }}</a></li>
                                  <li><a href="#"><img src="{{ asset('assets/img/icons/bath1.svg') }}"
                                        alt="Propertyfinda">{{ $listing->bathrooms ?? 'N/A' }}</a></li>
                                  <li><a href="#"><img src="{{ asset('assets/img/icons/sqare1.svg') }}"
                                        alt="Propertyfinda">{{ $listing->area_size ?? 'N/A' }} sq</a></li>
                                </ul>
                                <div class="btn-area">
                                  <a href="#" class="nm-btn">£{{ number_format($listing->price) }}</a>
                                  <a href="javascript:void(0)" class="heart"><img
                                      src="{{ asset('assets/img/icons/heart1.svg') }}" alt="Propertyfinda" class="heart1">
                                    <img src="{{ asset('assets/img/icons/heart2.svg') }}" alt="Propertyfinda"
                                      class="heart2"></a>
                                </div>
                              </div>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-rent" role="tabpanel" aria-labelledby="pills-rent-tab" tabindex="0">
                  <div class="swiper property-slider-rent">
                    <div class="swiper-wrapper">
                      @php
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="800">
          <div class="project-featured-box">
            <div class="img1">
              <img src="assets/img/all-images/project/project-img1.png" alt="Propertyfinda">
            </div>
            <div class="space40"></div>
            <div class="btn-area">
        ...
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1000">
          <div class="project-featured-box">
            <div class="img1">
              <img src="assets/img/all-images/project/project-img2.png" alt="Propertyfinda">
            </div>
            <div class="space40"></div>
            <div class="btn-area">
        ...
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1200">
          <div class="project-featured-box">
            <div class="img1">
              <img src="assets/img/all-images/project/project-img3.png" alt="Propertyfinda">
            </div>
            <div class="space40"></div>
            <div class="btn-area">
  ...
  <div class="items-section-area sp1"
    style="background-image: url(assets/img/all-images/bg/bg2.png); background-position: center; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-4">
          <div class="item-header heading1">
            ...
            <p data-aos="fade-left" data-aos-duration="900">At Propertyfinda, we’re redefining the way peoples find, sell,
              and
              invest the properties, our mission.</p>
            <div class="space28"></div>
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1000">
              <a href="sidebar-grid" class="theme-btn1">See All Properties <span class="arrow1"><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                    <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                  </svg></span><span class="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                    height="24" fill="currentColor">
        ...
        <div class="col-lg-4">
          <div class="box-slider">
            @forelse($featuredSellListings as $item)
              <div class="item-featured-boxarea">
                <h5>
                  ...
                  </span> {{ $item->address ?? 'UK Location' }}
                </h5>
                <div class="space20"></div>
                <h2><a href="{{ route('listing.show', $item->id) }}"
                    style="color: inherit; text-decoration: none;">{{ $item->property_title }}</a></h2>
                <div class="space28"></div>
                <h3>
                  @if($item->old_price)
                    <s style="color: #666; font-size: 0.8em; margin-right: 10px;">£{{ number_format($item->old_price) }}</s>
                  @endif
                  £{{ number_format($item->price) }}
                </h3>
                <div class="space28"></div>
                <div class="btn-area1">
                  <a href="{{ route('listing.show', $item->id) }}" class="theme-btn1">View Details <span class="arrow1"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                        <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                      </svg></span><span class="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        width="24" height="24" fill="currentColor">
            ...
            @foreach($propertyLocations as $location)
              <div class="propety-single-boxarea">
                <div class="img1 image-anime">
                  ...
                  @else
                    <img src="{{ asset('assets/img/all-images/property_location/property-img1.png') }}"
                      alt="{{ $location->name }}">
                  @endif
                </div>
                <h3>{{ $location->listing_count }}</h3>
                <a
                  href="{{ route('listings.index', ['lat' => $location->latitude, 'lng' => $location->longitude, 'radius' => 10]) }}">{{ $location->name }}</a>
              </div>
            @endforeach
          </div>
        </div>
  ...
  <div class="testimonial1-section-area sp1"
    style="background-image: url(assets/img/all-images/bg/bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
            ...
            <div class="row align-items-center">
              <div class="col-lg-5">
                <div class="images-area2 slider2">
                  <div class="img1 image-anime">
                    <img src="assets/img/all-images/testimonial/testimonial-img1.png" alt="Propertyfinda">
                  </div>
                  <div class="img1 image-anime">
                    <img src="assets/img/all-images/testimonial/testimonial-img1-1.png" alt="Propertyfinda">
                  </div>
                  <div class="img1 image-anime">
                    <img src="assets/img/all-images/testimonial/testimonial-img1-2.png" alt="Propertyfinda">
                  </div>
                  <div class="img1 image-anime">
                    <img src="assets/img/all-images/testimonial/testimonial-img1-3.png" alt="Propertyfinda">
                  </div>
                </div>
              </div>
              <div class="col-lg-7">
                <div class="testimonial-slider-area slider1">
                  <div class="testimonial-box">
                    <img src="assets/img/icons/quoto-icon1.svg" alt="Propertyfinda">
                    <div class="space16"></div>
                    <p>"When I decided to sell my home, I was overwhelmed with where to start. Propertyfinda stepped in
                      with a
                      clear plan, professional marketing, constant communicate. Within two weeks, my house was sold above
                      asking.”</p>
                    <div class="space32"></div>
                    <div class="test-images">
                      <div class="auhtor-area">
                        <div class="img1">
                          <img src="assets/img/all-images/testimonial/testimonial-img2.png" alt="Propertyfinda">
                        </div>
                        <div class="text">
                      ...
                      <img src="assets/img/elements/brand1.png" alt="Propertyfinda" class="brand1">
                    </div>
                  </div>
                  <div class="testimonial-box">
                    <img src="assets/img/icons/quoto-icon1.svg" alt="Propertyfinda">
                    <div class="space16"></div>
                    <p>"Selling our home felt like a huge challenge until we found. Their team guided us every step of the
                      way, from staging the property to negotiating offers. Within days, our home was sold for more than
                      we expected."</p>
                    <div class="space32"></div>
                    <div class="test-images">
                      <div class="auhtor-area">
                        <div class="img1">
                          <img src="assets/img/all-images/testimonial/testimonial-img3.png" alt="Propertyfinda">
                        </div>
                        <div class="text">
                  ...
                  <div class="testimonial-box">
                    <img src="assets/img/icons/quoto-icon1.svg" alt="Propertyfinda">
                    <div class="space16"></div>
                    <p>"We were first-time buyers, and the process seemed daunting. made everything so simple and
                      stress-free. They listened to our needs, showed us perfect options"</p>
                    <div class="space32"></div>
                    <div class="test-images">
                      <div class="auhtor-area">
                        <div class="img1">
                          <img src="assets/img/all-images/testimonial/testimonial-img4.png" alt="Propertyfinda">
                        </div>
                        <div class="text">
                  ...
                  <div class="testimonial-box">
                    <img src="assets/img/icons/quoto-icon1.svg" alt="Propertyfinda">
                    <div class="space16"></div>
                    <p>"I relocated for work and needed to sell my house quickly. [Your Real Estate Agency] delivered!
                      They handled everything smoothly, and I could focus on my move without worry. I highly recommend
                      their services."</p>
                    <div class="space32"></div>
                    <div class="test-images">
                      <div class="auhtor-area">
                        <div class="img1">
                          <img src="assets/img/all-images/testimonial/testimonial-img5.png" alt="Propertyfinda">
                        </div>
                        <div class="text">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-5" data-aos="zoom-in" data-aos-duration="1000">
                <div class="btn-area1 text-center">
                  <a href="{{ route('listings.index') }}" class="theme-btn1">Find Your Dream Home <span
                      class="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                        fill="currentColor">
                        <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                      </svg></span><span class="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      // Initialize Swipers
      var swiperSale = new Swiper(".property-slider-sale", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        autoplay: {
        ...
        pagination: {
          el: ".property-slider-sale .swiper-pagination",
          clickable: true,
        },
        breakpoints: {
          768: {
      ...
      var swiperRent = new Swiper(".property-slider-rent", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        autoplay: {
        ...
        pagination: {
          el: ".property-slider-rent .swiper-pagination",
          clickable: true,
        },
        breakpoints: {
          768: {
