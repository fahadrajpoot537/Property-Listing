                ...
                <div class="px-8 pt-10 pb-4 flex-shrink-0">
                    <div class="flex justify-between items-center mb-8">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-3xl font-black text-slate-900 tracking-tight" id="modalTitle">New Property
                                    Listing</h3>
                                <p class="text-[11px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-1">Portfolio
                                    Optimizer <span class="mx-2 text-slate-200">•</span>
                                    Step <span id="currentStepText" class="text-indigo-600">1</span> of 3</p>
                            </div>
                        </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function showStep(n) {
                ...
                $('#draftBtn').toggleClass('hidden', n !== 1); // Only show draft on first step to keep UI clean
            }
