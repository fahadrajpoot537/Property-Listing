                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-slate-900 tracking-tight" id="pageTitle">
                            {{ isset($listing) ? 'Edit Off-Market Listing' : 'Add New Off-Market Listing' }}
                        </h3>
                        <p class="text-[9px] text-black font-bold uppercase tracking-widest mt-0.5">
                            Off-Market Stream • Step <span id="currentStepText" class="text-indigo-600">1</span> of 3
                        </p>
                    </div>
                </div>
        ...
        <form id="listingForm" enctype="multipart/form-data" class="flex flex-col flex-1">
            ...
            <div class="px-6 py-6">
                ...
                <div id="stage1" class="space-y-6 transition-all duration-500 transform translate-x-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="property_reference_number" readonly
                                class="w-full rounded-lg border-slate-100 bg-slate-50 text-[13px] px-4 py-3 outline-none focus:bg-white focus:border-indigo-400 transition-all font-medium"
                    ...
                    <div
                        class="grid grid-cols-1 md:grid-cols-4 gap-8 p-6 bg-slate-50/50 rounded-3xl border border-slate-100">
                        <div>
                            <label
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-3">
                                <label class="block text-xs font-black text-black uppercase tracking-[0.2em]">Price
                                    (£)</label>
                                <label class="flex items-center gap-1.5 cursor-pointer">
                                    ...
                                    <span
                                        class="text-[9px] font-black uppercase text-rose-500 tracking-widest">Discount</span>
                                </label>
                            </div>
                        ...
                        <div id="discount_field_container"
                            ...
                            <label class="block text-xs font-black text-rose-500 uppercase tracking-[0.2em] mb-3">Old Price
                                (£)</label>
                            <input type="number" step="0.01" name="old_price" id="old_price"
                                class="w-full rounded-2xl border-rose-100 bg-rose-50 text-sm p-4 transition-all font-bold text-rose-600 placeholder-rose-300"
                                placeholder="Original Price" value="{{ $listing->old_price ?? '' }}">
                        </div>

                        <!-- Rent Only Fields -->
                        <div id="rent_fields_container"
                            class="{{ (isset($listing) && $listing->purpose == 'Rent') ? '' : 'hidden' }} md:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-200/50 mt-2">
                            <div>
                ...
                <div id="stage2" class="hidden space-y-12 transition-all duration-500">
                    ...
                    <div>
                        <label
                            class="block text-xs font-bold text-black uppercase tracking-wider mb-4 border-b pb-2">Property
                            Features</label>
                        ...
                        <div id="leasehold_fields"
                            ...
                            <div>
                                <label class="block text-xs font-bold text-black uppercase tracking-wider mb-2">Unexpired
                                    Years</label>
                                <input type="text" name="unexpired_years" placeholder="e.g 999"
                            ...
                            <div>
                                <label class="block text-xs font-bold text-black uppercase tracking-wider mb-2">Ground
                                    Rent (£)</label>
                                <input type="text" name="ground_rent" placeholder="e.g 10000"
                                    class="w-full rounded-lg border-slate-100 bg-slate-50/50 text-xs p-3"
                            ...
                            <div>
                                <label class="block text-xs font-bold text-black uppercase tracking-wider mb-2">Service
                                    Charge (£)</label>
                                <input type="text" name="service_charge" placeholder="e.g 900"
                                    class="w-full rounded-lg border-slate-100 bg-slate-50/50 text-xs p-3"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="p-4 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                            ...
                            <input type="file" name="epc_upload" id="epc_upload" accept="image/*,application/pdf"
                                class="w-full text-xs text-black file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:bg-emerald-50 file:text-emerald-700 file:font-bold hover:file:bg-emerald-100 cursor-pointer">
                        ...
                        <div class="p-4 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                            ...
                            <input type="file" name="brochure_pdf" id="brochure_pdf" accept="application/pdf"
                                class="w-full text-xs text-black file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:bg-red-50 file:text-red-700 file:font-bold hover:file:bg-red-100 cursor-pointer">
