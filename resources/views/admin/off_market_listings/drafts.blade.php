...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
            <h3 class="text-slate-800 font-extrabold text-2xl tracking-tight">Draft Off-Market Deals</h3>
            <p class="text-slate-500 text-sm mt-1 flex items-center gap-1">
                <i class='bx bxs-bolt text-amber-500'></i> Exclusive off-market and private deals.
            </p>
        </div>
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.off-market-listings.create') }}"
                ...
                <i class='bx bxs-zap text-xl text-yellow-300'></i> Add Off Market Deal
            </a>
        </div>
    </div>
    ...
    @push('scripts')
        ...
        <script>
                        ...
                        { data: 'user.name', render: d => `<span class="bg-slate-100 text-slate-700 px-3 py-1 rounded-lg text-[10px] font-black uppercase">${d}</span>` },
                        {
                            data: 'property_type.title', render: (d, t, r) => `
                                                                                                                                                                                                                                                                                                            <div class="flex flex-col">
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Deal</span>
                                                                                                                                                                                                                                                                                                            </div>`
                        },
            ...
            function editListing(id) {
                window.location.href = `/admin/off-market-listings/${id}/edit`;
            }
