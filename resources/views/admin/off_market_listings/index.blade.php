...
@section('header', 'Distress Listings Management')
...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
            <h3 class="text-slate-800 font-extrabold text-2xl tracking-tight">Distress Opportunties</h3>
                ...
                setTimeout(() => {
                    ...
                    autocomplete.addListener("place_changed", () => {
                        ...
                        if (p.geometry && p.geometry.location) {
                            ...
                            console.log('Location selected:', { lat, lng, address: p.name });
                        }
                    });
                }, 500);
            }
                    ...
                    if (input && typeof google !== 'undefined' && google.maps && google.maps.places) {
                        ...
                        autocomplete.addListener("place_changed", () => {
                            ...
                            if (p.geometry && p.geometry.location) {
                                ...
                                console.log('Location selected (openModal):', { lat, lng, address: p.name });
                            }
                        });
                    }
                }, 300);
                        ...
                        if (input && typeof google !== 'undefined' && google.maps && google.maps.places) {
                            ...
                            autocomplete.addListener("place_changed", () => {
                                ...
                                if (p.geometry && p.geometry.location) {
                                    ...
                                    console.log('Location selected (editListing):', { lat, lng, address: p.name });
                                }
                            });
                        }
                    }, 300);
