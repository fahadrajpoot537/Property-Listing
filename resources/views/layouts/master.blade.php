...
<head>
    ...
    <title>@yield('title', 'PropertyFinda - Real Estate Template')</title>
...
<body class="homepage1-body">
    ...
    <div class="header-search-form-wrapper">
        ...
        <div class="header-search-container">
            <form role="search" class="search-form">
                ...
                <button type="submit" class="search-submit"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                        ...
                        <path
                            ...
                            stroke="#030E0F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg></button>
            </form>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-top-area">
                            <ul class="header-content">
                                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        ...
                                        </svg> info@propertyfinda.co.uk</a> <span> | </span></li>

                            </ul>
                            <ul class="list-content">
                                <li><img src="{{ asset('assets/img/elements/elements11.png') }}" alt="housebox"><select
                                        name="country" id="country" class="country-area nice-select">
                                ...
                                @auth
                                    <li class="dropdown">
                                        <a href="#" class="signin dropdown-toggle" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span> | </span>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="#">Favorite Properties</a></li>
                                            <li>
                                ...
                                @else
                                    <li><a href="{{ route('login') }}" class="signin"><span> | </span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"
                                                viewBox="0 0 14 15" fill="none">
                                                <path
                                                    d="M7 1C4.96456 1 3.30859 2.65596 3.30859 4.69141C3.30859 6.72685 4.96456 8.38281 7 8.38281C9.03544 8.38281 10.6914 6.72685 10.6914 4.69141C10.6914 2.65596 9.03544 1 7 1Z"
                        ...
                        <div class="header-elements">
                            <div class="site-logo">
                                <a href="{{ url('/') }}"><img src="{{ asset('logo.png') }}" alt="housebox"></a>
                            </div>
                            <div class="main-menu">
                                <ul>
                                    <li><a href="{{ url('/') }}">Home</a></li>
                                    <li><a href="{{ route('off-market-listings.index') }}">Off Market</a></li>
                            ...
                            <div class="btn-area">
                                ...
                                <a href="{{ route('listings.index') }}" class="theme-btn1">View Listing <span
                                        class="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            ...
            <div class="col-12">
                <div class="mobile-header-elements">
                    <div class="mobile-logo">
                        <a href="{{ url('/') }}"><img src="{{ asset('assets/img/logo/logo1.png') }}" alt="housebox"></a>
                    </div>
                    <div class="mobile-right d-flex gap-1 align-items-center">
                        <a class="circle-button user-icon" href="#">
                        ...
                        <a class="circle-button add-icon" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                                fill="none">
    ...
    <div class="mobile-sidebar mobile-sidebar1">
        <div class="logosicon-area">
            <div class="logos">
                <img src="{{ asset('assets/img/logo/logo1.png') }}" alt="housebox">
            </div>
        ...
        <div class="mobile-nav mobile-nav1">
            ...
            <div class="allmobilesection">
                <a href="#" class="theme-btn1">Contact Us <span class="arrow1"><svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                            <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                    ...
                    <div class="footer1-contact-info">
                        ...
                        <div class="single-footer">
                            ...
                            <div class="contact-info-single">
                                ...
                                <div class="contact-info-text">
                                    <a href="#">123 Oxford Street, <br> London W1D 1LL, United Kingdom</a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-logoarea">
                        <img src="{{ asset('logo.png') }}" alt="housebox">
                        <div class="space24"></div>
                        <p>As Propertyfinda’s lead negotiator, Chris brings years of experience in securing the best
                            deals
                            both.</p>
                        <div class="space24"></div>
                        <ul>
                    ...
                    <div class="footer-content2">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    ...
                                    </svg> 5–7 High Street, London, England E13 0AD</a></li>

                            <li><a href="mailto:info@propertyfinda.co.uk"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                            d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM12.0606 11.6829L5.64722 6.2377L4.35278 7.7623L12.0731 14.3171L19.6544 7.75616L18.3456 6.24384L12.0606 11.6829Z">
                                        </path>
                                    </svg> info@propertyfinda.co.uk</a></li>
                    ...
                    <div class="instagram-posts">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-4">
                                <div class="img1">
                                    <img src="{{ asset('assets/img/all-images/footer/footer-img1.png') }}"
                                        alt="housebox">
                                    <div class="icons">
                            ...
                            <div class="col-lg-4 col-4">
                                <div class="img1">
                                    <img src="{{ asset('assets/img/all-images/footer/footer-img2.png') }}"
                                        alt="housebox">
                                    <div class="icons">
                                        <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-4">
                                <div class="img1">
                                    <img src="{{ asset('assets/img/all-images/footer/footer-img3.png') }}"
                                        alt="housebox">
                                    <div class="icons">
                                        <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-4">
                                <div class="img1">
                                    <img src="{{ asset('assets/img/all-images/footer/footer-img4.png') }}"
                                        alt="housebox">
                                    <div class="icons">
                                        <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-4">
                                <div class="img1">
                                    <img src="{{ asset('assets/img/all-images/footer/footer-img5.png') }}"
                                        alt="housebox">
                                    <div class="icons">
                                        <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-4">
                                <div class="img1">
                                    <img src="{{ asset('assets/img/all-images/footer/footer-img6.png') }}"
                                        alt="housebox">
                                    <div class="icons">
                                        <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright text-center">
                        <p>© Copyright 2024 - PropertyFinda. All Rights Reserved | Designed by MediaJunkie</p>
                    </div>
