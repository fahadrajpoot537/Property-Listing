...
@section('content')
    ...
    <div class="relative py-20 md:py-28 bg-primary overflow-hidden">
        <div class="absolute inset-0">
            <img src="{{ asset('4.jpg') }}" class="w-full h-full object-cover opacity-40 mix-blend-overlay" alt="GDPR Hero">
            <div class="absolute inset-0 bg-gradient-to-b from-primary/80 to-primary"></div>
        </div>
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-6xl font-black text-white tracking-tight mb-4">GDPR Compliance</h1>
            <p class="text-xl text-white max-w-2xl mx-auto">Ensuring your data protection rights</p>
        </div>
    </div>
